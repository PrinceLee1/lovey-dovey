  ...
  return (
    <div className="rounded-3xl bg-white dark:bg-gray-900 shadow-xl border border-rose-100 dark:border-gray-800 p-5">
      <div className="flex items-center justify-between mb-4">
        <div className="font-display font-semibold text-gray-900 dark:text-gray-100">Your Progress</div>
      ...
      <div className="mt-5 text-sm text-gray-600 dark:text-gray-400">Weekly Streak</div>
      <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 text-sm mb-1">
